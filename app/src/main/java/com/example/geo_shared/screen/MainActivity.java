...
public class MainActivity extends AppCompatActivity implements CityFetcher.CityFetchListener, CountryFetcher.OnCountryFetchListener {
    ...
    TextView countryName, text_name, text_bioma;
    ...
    public void ClickBioma(View view) {
        redirect(this, BiomaActivity.class);
    }

    public void ClickContinente(View view) {
        redirect(this, ContinenteActivity.class);
    }

    public void ClickProvincia(View view) {
        redirect(this, ProvinciaActivity.class);
    }

    public void ClickPresidente(View view) {
        redirect(this, PresidenteActivity.class);
    }
}